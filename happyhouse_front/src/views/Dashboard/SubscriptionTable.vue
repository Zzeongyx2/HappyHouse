    ...
    <template v-slot:header>
      <b-row align-v="center">
        ...
        <b-col class="text-right">
          <a href="https://www.applyhome.co.kr/co/coa/selectMainView.do" target="_blank" class="btn btn-sm btn-primary">더 보기</a>
        </b-col>
      </b-row>
    </template>
        ...
        <el-table-column type="expand">
                <template #default="props">
                    <div m="4" font-family="sans-serif" font-size="15px">
                        ...
                        <br/>
                        청약 접수 : {{props.row.RCEPT_BGNDE}} ~ {{props.row.RCEPT_ENDDE}}
                        <br/>
...
export default {
  ...
  data() {
      return {
          param: {
              serviceKey: "cG+goOX7r+H556sFCeCqakNiCNGWOQagcjsamQqj0pwG92h8N6i5IB2L66ouCGde4c9CWVUO+ikznTKfTAoyMA==",
              page: 1,
              perPage: 20,
          },
          subList: [],
