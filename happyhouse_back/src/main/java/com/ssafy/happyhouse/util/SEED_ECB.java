...
public class SEED_ECB {
	...
	*/
	 ...
	 * 
	 * // User secret key byte pbUserKey[] = {(byte)0x88, (byte)0xE3, (byte)0x4F,
	 * (byte)0x8F, (byte)0x08, (byte)0x17, (byte)0x79, (byte)0xF1, (byte)0xE9,
	 * (byte)0xF3, (byte)0x94, (byte)0x37, (byte)0x0A, (byte)0xD4, (byte)0x05,
	 * (byte)0x89};
	 * 
	 * byte pbData[] = {(byte)0xD7, (byte)0x6D, (byte)0x0D, (byte)0x18, (byte)0x32,
	 * (byte)0x7E, (byte)0xC5, (byte)0x62, (byte)0xB1, (byte)0x5E, (byte)0x6B,
	 * (byte)0xC3, (byte)0x65, (byte)0xAC, (byte)0x0C, (byte)0x0F};
	 * 
	 * byte pbData1[] = {(byte)0x00, (byte)0x01}; byte pbData2[] = {(byte)0x00,
	 * (byte)0x01, (byte)0x02, (byte)0x03, (byte)0x04, (byte)0x05, (byte)0x06,
	 * (byte)0x07, (byte)0x08, (byte)0x09, (byte)0x0A, (byte)0x0B, (byte)0x0C,
	 * (byte)0x0D, (byte)0x0E, (byte)0x0F, (byte)0x00, (byte)0x01}; byte pbCipher[]
	 * = new byte[50]; byte pbPlain[] = new byte[16];
	 * 
	 * System.out.print("\n");
	 ...
	 * //System.out.print("\n\n방법 1 \n[ Test Encrypt mode ]"+"\n\n");
	 * System.out.print("Key\t\t: "); for (int i=0; i<16; i++)
	 * System.out.print(Integer.toHexString(0xff&pbUserKey[i])+" ");
	 * System.out.print("\n"); System.out.print("Plaintext\t: "); for (int i=0;
	 * i<16; i++) System.out.print(Integer.toHexString(0xff&pbData[i])+" ");
	 * System.out.print("\n\n\n");
	 * 
	 ...
	 * 
	 * System.out.print("Ciphertext(SEED_ECB_Encrypt)\t: "); for (int i=0; i<32;
	 * i++) System.out.print(Integer.toHexString(0xff&pbCipher[i])+" ");
	 * System.out.print("\n");
	 * 
	 * System.out.print("Plaintext(SEED_ECB_Decrypt)\t: "); for (int i=0; i<16; i++)
	 * System.out.print(Integer.toHexString(0xff&pbPlain[i])+" ");
	 * System.out.print("\n\n\n");
	 * 
	 * 
	 * pbCipher = null; pbPlain = null;
	 * 
	 * 
	 * 
	 ...
	 * 
	 * System.out.print("Ciphertext(enc)\t: "); for (int i=0; i<16; i++)
	 * System.out.print(Integer.toHexString(0xff&pbCipher[i])+" ");
	 * System.out.print("\n");
	 * 
	 * System.out.print("Plaintext(dec)\t: "); for (int i=0; i<2; i++)
	 * System.out.print(Integer.toHexString(0xff&pbPlain[i])+" ");
	 * System.out.print("\n\n");
	 * 
	 * pbCipher = null; pbPlain = null;
	 ...
	 * pbPlain = SEED_ECB_Decrypt(pbUserKey, pbCipher, 0, 32);
	 * 
	 * System.out.print("Ciphertext(enc)\t: "); for (int i=0; i<32; i++)
	 * System.out.print(Integer.toHexString(0xff&pbCipher[i])+" ");
	 * System.out.print("\n");
	 * 
	 * System.out.print("Plaintext(dec)\t: "); for (int i=0; i<18; i++)
	 * System.out.print(Integer.toHexString(0xff&pbPlain[i])+" ");
	 * System.out.print("\n\n");
	 * 
	 * pbCipher = null; pbPlain = null;
	...
	/*
	 * 
	 * int PLAINTEXT_LENGTH = 16; int CIPHERTEXT_LENGTH;
	 * 
	 * KISA_SEED_INFO info = new KISA_SEED_INFO(); SEED_ECB_init( info,
	 * KISA_ENC_DEC.KISA_ENCRYPT, pbUserKey);
	 * 
	 * int process_blockLeng = 32; int[] outbuf = new int[process_blockLeng]; int i;
	 * int[] data; byte[] cdata; int nRetOutLeng[] = new int[] { 0 }; int
	 * nPaddingLeng[] = new int[] { 0 }; byte[] pbszPlainText = new
	 * byte[process_blockLeng]; int nPlainTextPadding = (BLOCK_SIZE_SEED -
	 * (PLAINTEXT_LENGTH)%BLOCK_SIZE_SEED);
	 * 
	 ...
	 * System.arraycopy(pbData, i, pbszPlainText, 0, process_blockLeng); data =
	 * chartoint32_for_SEED_ECB(pbszPlainText, process_blockLeng); SEED_ECB_Process(
	 * info, data, process_blockLeng, outbuf, nRetOutLeng ); cdata =
	 * int32tochar_for_SEED_ECB(outbuf, nRetOutLeng[0]); System.arraycopy(cdata, 0,
	 * pbszCipherText, i, nRetOutLeng[0]); i += nRetOutLeng[0]; } int remainleng =
	 * PLAINTEXT_LENGTH % process_blockLeng; if (remainleng == 0) { remainleng =
	 * process_blockLeng; } System.arraycopy(pbData, i, pbszPlainText, 0,
	 * remainleng); data = chartoint32_for_SEED_ECB(pbszPlainText, remainleng);
	 * SEED_ECB_Process( info, data, remainleng, outbuf, nRetOutLeng ); cdata =
	 * int32tochar_for_SEED_ECB(outbuf, nRetOutLeng[0]); System.arraycopy(cdata, 0,
	 * pbszCipherText, i, nRetOutLeng[0]); i += nRetOutLeng[0];
	 * 
	 * SEED_ECB_Close( info, outbuf, 0, nPaddingLeng ); cdata =
	 * int32tochar_for_SEED_ECB(outbuf, nPaddingLeng[0]); System.arraycopy(cdata, 0,
	 * pbszCipherText, i, nPaddingLeng[0]);
	 * 
	 * 
	 * System.out.print("Ciphertext(enc)\t: "); for(i=0; i<CIPHERTEXT_LENGTH; i++)
	 * System.out.print(Integer.toHexString(0xff&pbszCipherText[i])+" ");
	 * 
	 * System.out.print("\n");
	 * 
	 * data = null; cdata = null; outbuf = null; info = null;
	 * 
	 * 
	 * 
	 * 
	 ...
	 * 
	 * int EncryptedMessage_length = CIPHERTEXT_LENGTH; if (EncryptedMessage_length
	 * % BLOCK_SIZE_SEED > 0) { System.out.print("DECRYPT FAIL! "); } else {
	 ...
	 * 
	 * byte[] cipherText = new byte[process_blockLeng]; pbszPlainText = new
	 * byte[EncryptedMessage_length];
	 * 
	 * for (i = 0; i < EncryptedMessage_length - process_blockLeng; ) {
	 * System.arraycopy(pbszCipherText, i, cipherText, 0, process_blockLeng); data =
	 * chartoint32_for_SEED_ECB(cipherText, process_blockLeng); SEED_ECB_Process(
	 * info, data, process_blockLeng, outbuf, nRetOutLeng ); cdata =
	 * int32tochar_for_SEED_ECB(outbuf, nRetOutLeng[0]); System.arraycopy(cdata, 0,
	 * pbszPlainText, i, nRetOutLeng[0]); i += nRetOutLeng[0]; }
	 * 
	 * remainleng = EncryptedMessage_length % process_blockLeng; if (remainleng ==
	 * 0) { remainleng = process_blockLeng; }
	 * 
	 * 
	 * System.arraycopy(pbszCipherText, i, cipherText, 0, remainleng); data =
	 * chartoint32_for_SEED_ECB(cipherText, remainleng); SEED_ECB_Process( info,
	 * data, remainleng, outbuf, nRetOutLeng ); if (SEED_ECB_Close( info, outbuf,
	 * nRetOutLeng[0], nPaddingLeng ) > 0 ) { cdata = int32tochar_for_SEED_ECB(
	 * outbuf, remainleng - nPaddingLeng[0] ); System.arraycopy(cdata, 0,
	 * pbszPlainText, i, remainleng - nPaddingLeng[0]); int message_length = i +
	 * remainleng - nPaddingLeng[0];
	 * 
	 * result = new byte[message_length]; System.arraycopy(pbszPlainText, 0, result,
	 * 0, message_length); data = null; cdata = null; outbuf = null; } else { result
	 * = new byte[10]; System.out.print("DECRYPT FAIL! "); }
	 * 
	 * }
	 * 
	 * System.out.print("Plaintext(dec)\t: "); for (i=0; i<PLAINTEXT_LENGTH; i++)
	 ...
	 * 
	 * 
	 * info = new KISA_SEED_INFO(); SEED_ECB_init( info, KISA_ENC_DEC.KISA_ENCRYPT,
	 * pbUserKey);
	 * 
	 * process_blockLeng = 32; outbuf = new int[process_blockLeng]; pbszPlainText =
	 * new byte[process_blockLeng]; nPlainTextPadding = (BLOCK_SIZE_SEED -
	 * (PLAINTEXT_LENGTH)%BLOCK_SIZE_SEED);
	 * 
	 * CIPHERTEXT_LENGTH = PLAINTEXT_LENGTH + nPlainTextPadding;
	 * 
	 ...
	 * info, data, process_blockLeng, outbuf, nRetOutLeng ); cdata =
	 * int32tochar_for_SEED_ECB(outbuf, nRetOutLeng[0]); System.arraycopy(cdata, 0,
	 * pbszCipherText, i, nRetOutLeng[0]); i += nRetOutLeng[0]; } remainleng =
	 * PLAINTEXT_LENGTH % process_blockLeng; if (remainleng == 0) { remainleng =
	 * process_blockLeng; } System.arraycopy(pbData, i, pbszPlainText, 0,
	 * remainleng); data = chartoint32_for_SEED_ECB(pbszPlainText, remainleng);
	 * SEED_ECB_Process( info, data, remainleng, outbuf, nRetOutLeng ); cdata =
	 ...
	 * info = new KISA_SEED_INFO();
	 * 
	 * EncryptedMessage_length = CIPHERTEXT_LENGTH; if (EncryptedMessage_length %
	 * BLOCK_SIZE_SEED > 0) { System.out.print("DECRYPT FAIL! "); } else {
	 * SEED_ECB_init( info, KISA_ENC_DEC.KISA_DECRYPT, pbUserKey);
	 * 
	 * process_blockLeng = 32;
	 ...
	 * nRetOutLeng[0], nPaddingLeng ) > 0 ) { cdata = int32tochar_for_SEED_ECB(
	 * outbuf, remainleng - nPaddingLeng[0] ); System.arraycopy(cdata, 0,
	 * pbszPlainText, i, remainleng - nPaddingLeng[0]); PLAINTEXT_LENGTH = i +
	 * remainleng - nPaddingLeng[0];
	 * 
	 * result = new byte[PLAINTEXT_LENGTH]; System.arraycopy(pbszPlainText, 0,
	 * result, 0, PLAINTEXT_LENGTH); data = null; cdata = null; outbuf = null; }
	 * else { result = new byte[10]; System.out.print("DECRYPT FAIL! "); }
	 * 
	 * }
	 * 
	 * System.out.print("Plaintext(dec)\t: "); for (i=0; i<PLAINTEXT_LENGTH; i++)
	 ...
	 *//*********************************************************************
		 ...
		 *********************************************************************//*
																				 ...
																				 * pbUserKey);
																				 * 
																				 * process_blockLeng = 32; outbuf = new
																				 * int[process_blockLeng]; pbszPlainText
																				 * = new byte[process_blockLeng];
																				 * nPlainTextPadding = (BLOCK_SIZE_SEED
																				 * -
																				 * (PLAINTEXT_LENGTH)%BLOCK_SIZE_SEED);
																				 * 
																				 ...
																				 * 
																				 * pbszCipherText = new
																				 * byte[PLAINTEXT_LENGTH +
																				 * nPlainTextPadding];
																				 * 
																				 * for (i = 0; i < PLAINTEXT_LENGTH -
																				 * process_blockLeng; ) {
																				 * System.arraycopy(pbData2, i,
																				 * pbszPlainText, 0, process_blockLeng);
																				 * data = chartoint32_for_SEED_ECB(
																				 * pbszPlainText, process_blockLeng);
																				 * SEED_ECB_Process( info, data,
																				 * process_blockLeng, outbuf,
																				 * nRetOutLeng ); cdata =
																				 * int32tochar_for_SEED_ECB(outbuf,
																				 * nRetOutLeng[0]);
																				 * System.arraycopy(cdata, 0,
																				 * pbszCipherText, i, nRetOutLeng[0]); i
																				 * += nRetOutLeng[0]; } remainleng =
																				 * PLAINTEXT_LENGTH % process_blockLeng;
																				 * if (remainleng == 0) { remainleng =
																				 * process_blockLeng; }
																				 * System.arraycopy(pbData2, i,
																				 * pbszPlainText, 0, remainleng); data =
																				 * chartoint32_for_SEED_ECB(
																				 * pbszPlainText, remainleng);
																				 * SEED_ECB_Process( info, data,
																				 * remainleng, outbuf, nRetOutLeng );
																				 * cdata =
																				 * int32tochar_for_SEED_ECB(outbuf,
																				 * nRetOutLeng[0]);
																				 * System.arraycopy(cdata, 0,
																				 ...
																				 * 0xff&pbszCipherText[i])+" ");
																				 * 
																				 * System.out.print("\n");
																				 * 
																				 * data = null; cdata = null; outbuf =
																				 * null; info = null;
																				 * 
																				 * 
																				 * //복호 CIPHERTEXT_LENGTH = 32;
																				 * 
																				 * result = new byte[] {0};
																				 * 
																				 * info = new KISA_SEED_INFO();
																				 * 
																				 * EncryptedMessage_length =
																				 * CIPHERTEXT_LENGTH; if
																				 * (EncryptedMessage_length %
																				 * BLOCK_SIZE_SEED > 0) {
																				 * System.out.print("DECRYPT FAIL! "); }
																				 * else { SEED_ECB_init( info,
																				 ...
																				 * EncryptedMessage_length -
																				 * process_blockLeng; ) {
																				 * System.arraycopy(pbszCipherText, i,
																				 * cipherText, 0, process_blockLeng);
																				 * data =
																				 * chartoint32_for_SEED_ECB(cipherText,
																				 * process_blockLeng); SEED_ECB_Process(
																				 * info, data, process_blockLeng,
																				 * outbuf, nRetOutLeng ); cdata =
																				 * int32tochar_for_SEED_ECB(outbuf,
																				 * nRetOutLeng[0]);
																				 * System.arraycopy(cdata, 0,
																				 * pbszPlainText, i, nRetOutLeng[0]); i
																				 * += nRetOutLeng[0]; }
																				 * 
																				 * remainleng = EncryptedMessage_length
																				 * % process_blockLeng; if (remainleng
																				 * == 0) { remainleng =
																				 * process_blockLeng; }
																				 * 
																				 * 
																				 * System.arraycopy(pbszCipherText, i,
																				 * cipherText, 0, remainleng); data =
																				 * chartoint32_for_SEED_ECB(cipherText,
																				 * remainleng); SEED_ECB_Process( info,
																				 * data, remainleng, outbuf, nRetOutLeng
																				 * ); if (SEED_ECB_Close( info, outbuf,
																				 * nRetOutLeng[0], nPaddingLeng ) > 0 )
																				 * { cdata = int32tochar_for_SEED_ECB(
																				 * outbuf, remainleng - nPaddingLeng[0]
																				 * ); System.arraycopy(cdata, 0,
																				 * pbszPlainText, i, remainleng -
																				 * nPaddingLeng[0]); PLAINTEXT_LENGTH =
																				 * i + remainleng - nPaddingLeng[0];
																				 * 
																				 * result = new byte[PLAINTEXT_LENGTH];
																				 * System.arraycopy(pbszPlainText, 0,
																				 * result, 0, PLAINTEXT_LENGTH); data =
																				 * null; cdata = null; outbuf = null; }
																				 * else { result = new byte[10];
																				 * System.out.print("DECRYPT FAIL! "); }
																				 * 
																				 * }
																				 * 
